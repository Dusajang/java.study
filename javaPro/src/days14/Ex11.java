...
public class Ex11 {
	...
	public static void main(String[] args) {
		...
		//1. 사원 객체 생성해서 출력
		/*
		Employee emp1 = new Employee("송세호", "서울 강남구", "010-1234-1234", "2022.12.22" );
		emp1.dispEmpInfo();
		*/
